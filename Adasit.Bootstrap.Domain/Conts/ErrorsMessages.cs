namespace Adasit.Bootstrap.Domain.Conts;
public static class ErrorsMessages
{
    ...
    public static readonly string FinalDateCannotBeBeforeStartDate = "Final date has to be unless one hour plus start date.";
